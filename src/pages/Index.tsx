        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="font-sans-elegant text-[11px] font-bold text-foreground drop-shadow-sm">Premium Event</span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="font-sans-elegant text-[11px] font-bold text-foreground drop-shadow-sm">150+ Guests</span>
            </motion.div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            ...
            <div className="flex flex-col gap-6 items-center md:items-end md:translate-y-12">
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-sans-elegant text-lg font-extrabold text-foreground drop-shadow-sm">4.8</span>
                </div>
                <p className="font-sans-elegant text-xs font-bold text-foreground">Guest Reviews</p>
                <p className="font-sans-elegant text-[10px] text-foreground/60 font-medium">150+ invited</p>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="font-sans-elegant text-sm font-bold text-foreground drop-shadow-sm">Celestial Calm</p>
                  <p className="font-sans-elegant text-xs text-foreground/60 font-medium">2:10 mins</p>
                </div>
            ...
            <div className="flex flex-col gap-6 items-center md:items-start md:-translate-y-8">
              ...
              >
                ...
                <span className="font-sans-elegant text-sm font-bold text-foreground drop-shadow-sm">Forever & Always</span>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="font-sans-elegant text-sm font-bold text-foreground drop-shadow-sm">Forever & Always</p>
                  <p className="font-sans-elegant text-xs text-foreground/60 font-medium">3:22 mins</p>
                </div>
                <div className="w-8 h-8 rounded-full bg-background/80 dark:bg-background/40 flex items-center justify-center ml-1">
                  <Play className="w-3 h-3 text-foreground fill-foreground" />
                </div>
              ...
              >
                <p className="font-sans-elegant text-xs text-foreground/60 font-medium mb-1">15 Aug 2027</p>
                <p className="font-sans-elegant text-sm font-bold text-foreground drop-shadow-sm">Start Your Journey</p>
                <p className="font-sans-elegant text-xs text-foreground/60 font-medium mt-1">A celebration of love</p>
              </motion.div>
            </div>
