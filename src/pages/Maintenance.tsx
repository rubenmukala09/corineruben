...
function Maintenance() {
    ...
    updates: [
      {
        ...
        message: "Beginning scheduled maintenance",
      },
    ],
  };
  ...
  const progressPercentage = () => {
    const now = new Date();
    const total =
      maintenanceData.expectedCompletion.getTime() -
      maintenanceData.startTime.getTime();
      ...
      <div className="max-w-2xl w-full">
        <Card className="p-8 md:p-12 text-center space-y-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed max-w-lg mx-auto">
            We're performing scheduled maintenance to bring you new features and
            improved performance. Thank you for your patience!
          </p>
          ...
          <div className="flex items-center justify-center gap-3 text-muted-foreground">
            ...
            <span className="text-lg">
              Time Remaining:{" "}
              <strong className="text-foreground">{timeRemaining}</strong>
            </span>
          </div>
