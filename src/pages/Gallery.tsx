...
const Gallery = () => {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    // Upload to Supabase Storage bucket "wedding-photos"
    ...
    <div className="min-h-screen pt-28 pb-20 relative">
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-4xl relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <p className="font-sans-elegant text-base text-muted-foreground mb-6" style={{ lineHeight: 1.6 }}>
            {t('gallery.subtitle')}
          </p>
          <button
            type="button"
        ...
        {/* Photo grid */}
        {photos.length === 0 ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass-card-strong rounded-3xl p-16 text-center">
