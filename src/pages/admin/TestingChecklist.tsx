...
export default function TestingChecklist() {
  const [functionalityChecklist, setFunctionalityChecklist] = useState<
    ChecklistSection[]
  >([
    {
      title: "Homepage",
      items: [
        ...
        {
          id: "home-buttons",
          label: "Buttons go to right pages",
          checked: false,
        },
        {
          id: "home-animations",
          label: "Animations play smoothly",
          checked: false,
        },
        { id: "home-stats", label: "Statistics count up", checked: false },
        {
          id: "home-testimonials",
          label: "Testimonials cycle",
          checked: false,
        },
        {
          id: "home-forms",
          label: "Forms submit successfully",
          checked: false,
        },
        {
          id: "home-mobile-nav",
    ...
    },
    {
      ...
      items: [
        { id: "contact-submit", label: "Form submits", checked: false },
        {
          ...
          label: "Validation works (email, phone format)",
          checked: false,
        },
        {
          id: "contact-errors",
          label: "Error messages show correctly",
          checked: false,
        },
        {
          id: "contact-success",
        ...
        {
          id: "contact-admin-notify",
          label: "Admin receives notification",
          checked: false,
        },
      ],
    },
    {
      ...
      items: [
        {
          id: "login-correct",
          label: "Login with correct credentials works",
          checked: false,
        },
        {
          id: "login-wrong",
          label: "Login with wrong credentials fails",
          checked: false,
        },
        {
          id: "forgot-password",
          label: "'Forgot password' sends email",
          checked: false,
        },
        {
          id: "password-reset",
          label: "Password reset link works",
          checked: false,
        },
  ...
  const [responsiveChecklist, setResponsiveChecklist] = useState<
    ChecklistItem[]
  >([
    ...
    {
      id: "buttons-tappable",
      label: "Buttons are tappable (min 44px)",
      checked: false,
    },
  ]);
  ...
  const [seoChecklist, setSeoChecklist] = useState<ChecklistItem[]>([
    {
      id: "unique-titles",
      label: "Every page has unique title tag",
      checked: false,
    },
    {
      id: "meta-descriptions",
      label: "Every page has meta description",
      checked: false,
    },
  ...
  >([
    {
      id: "pagespeed-90",
      label: "PageSpeed Insights: 90+ (mobile & desktop)",
      checked: false,
    },
          ...
          <Card className="p-6 bg-[#111827] border-gray-800">
            <div className="mb-4">
              ...
              <p className="text-sm text-[#9CA3AF] mt-2">
                {Math.round(functionalityProgress)}% complete
              </p>
            </div>
                ...
                <div className="space-y-3">
                  {section.items.map((item) => (
                    <div key={item.id} className="flex items-center gap-3">
                      ...
                      <label
                        htmlFor={item.id}
                        className="text-sm cursor-pointer text-[#9CA3AF]"
                      >
                        {item.label}
                      </label>
                    </div>
        ...
        <TabsContent value="responsive" className="space-y-4">
          <Card className="p-6 bg-[#111827] border-gray-800">
            <div className="mb-4">
              ...
              <p className="text-sm text-[#9CA3AF] mt-2">
                {Math.round(responsiveProgress)}% complete
              </p>
            </div>
        ...
        <TabsContent value="seo" className="space-y-4">
          <Card className="p-6 bg-[#111827] border-gray-800">
            <div className="mb-4">
              ...
              <p className="text-sm text-[#9CA3AF] mt-2">
                {Math.round(seoProgress)}% complete
              </p>
            </div>
              ...
              {seoChecklist.map((item) => (
                <div key={item.id} className="flex items-center gap-3">
                  <Checkbox
                    ...
                    checked={item.checked}
                    onCheckedChange={() =>
                      toggleSimpleItem(seoChecklist, setSeoChecklist, item.id)
                    }
                  />
                  <label
                    htmlFor={item.id}
        ...
        <TabsContent value="performance" className="space-y-4">
          <Card className="p-6 bg-[#111827] border-gray-800">
            <div className="mb-4">
              ...
              <p className="text-sm text-[#9CA3AF] mt-2">
                {Math.round(performanceProgress)}% complete
              </p>
            </div>
