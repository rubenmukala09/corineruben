      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[#9CA3AF]">
            Monitor and protect all connected devices
          </p>
        </div>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewDevice((prev) => ({ ...prev, device_type: value }))
                  }
                >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#9CA3AF]">
                          {device.device_type} • Last scan:{" "}
                          {device.last_scan
                            ? formatDistanceToNow(new Date(device.last_scan), {
                                addSuffix: true,
                              })
                            : "Never"}
                        </p>
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <span
                        className={`font-medium min-w-[80px] text-right ${getStatusColor(device.status)}`}
                      >
