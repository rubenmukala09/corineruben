    ...
    try {
      if (format === "csv") {
        ...
        toast({
          ...
          description: "Articles exported as CSV",
        });
      } else {
        toast({
            ...
            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="AI Scams">
                  AI Scams{" "}
                  {categoryCounts["AI Scams"] &&
                    `(${categoryCounts["AI Scams"]})`}
                </SelectItem>
                <SelectItem value="Business AI">
                  Business AI{" "}
                  {categoryCounts["Business AI"] &&
                    `(${categoryCounts["Business AI"]})`}
                </SelectItem>
                        ...
                        >
                          <div className="flex items-center justify-end gap-2">
                            <Button
                              ...
                              onClick={() =>
                                navigate(
                                  `/admin/content/articles/${article.id}`,
                                )
                              }
                            >
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this article. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
