      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[#9CA3AF]">
            Manage your team members and their display settings
          </p>
        </div>
        <Button
          size="lg"
      ...
      <div className="space-y-6">
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                Remove {memberToDelete?.name} from team?
              </AlertDialogTitle>
              <AlertDialogDescription>
                They will no longer appear on the About page. This action cannot
                be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
