    ...
    return (
      <ScrollReveal animation="fade-up" delay={index * 100} threshold={0.2}>
        <div className="relative h-full pt-5">
          ...
          <div
            className={`p-6 pt-8 rounded-2xl bg-card border transition-all hover:-translate-y-1 h-full flex flex-col ${
              plan.popular
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 justify-center mb-4">
              <Badge
                className={`${plan.badgeClass || "bg-muted text-muted-foreground"}`}
              >
                {plan.badge}
              </Badge>
            </div>
              ...
              {TRUST_PILLARS.map((item, index) => (
                ...
                >
                  <div className="bg-card border border-border rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-all hover:-translate-y-1 h-full">
                    <div
                      className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mx-auto mb-4`}
                    >
              ...
              <ScrollReveal animation="fade-up">
                <div className="bg-card border border-border rounded-2xl p-8 shadow-sm h-full">
                  ...
                  <ol className="space-y-3">
                    {[
                      {
                        step: "Stop immediately.",
                        detail: "Hang up / stop replying. Take a breath.",
                      },
                      {
                        step: "Verify independently.",
                        detail:
                          "Call back using the official number on your card.",
                      },
                      {
                        step: "Use your safeword",
                        detail: "with family before taking any action.",
                      },
                      {
                        step: "Double-check money requests",
                        detail: "with a second family member.",
                      },
                      {
                        step: "Report and document",
                        detail: "the attempt (we provide templates).",
                      },
                    ].map((item, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        <span className="w-8 h-8 bg-gradient-to-br from-red-500 to-orange-500 text-white rounded-lg flex items-center justify-center font-bold text-sm flex-shrink-0">
                          {idx + 1}
                        </span>
              ...
              <ScrollReveal animation="fade-up" delay={100}>
                <div className="bg-card border border-border rounded-2xl p-8 shadow-sm h-full">
                  ...
                  <ul className="space-y-3">
                    {[
                      {
                        action: "Demand specifics:",
                        detail:
                          "Full name, department, callback number, case number.",
                      },
                      {
                        action: "Always say:",
                        detail: '"I\'ll call you back through the main line."',
                      },
                      {
                        action: "Never share:",
                        detail: "Codes, passwords, or download any software.",
                      },
                      {
                        action: "Forward suspicious items",
                        detail: "to our help line for expert review.",
                      },
                    ].map((item, idx) => (
                      <li key={idx} className="flex items-start gap-3">
              ...
              {[
                ...
                >
                  <div className="relative bg-card border border-border rounded-2xl p-8 text-center shadow-sm hover:shadow-md transition-all hover:-translate-y-1 h-full">
                    <div
                      className={`absolute top-4 right-4 w-10 h-10 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center`}
                    >
                    ...
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mx-auto mb-5`}
                    >
            ...
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <p className="text-lg text-foreground max-w-4xl mx-auto mb-2">
                  With the rise of AI, scammers have become more sophisticated
                  than ever.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Our process is designed to be effortless. Just forward it to
                  us.
                </p>
              </ScrollReveal>
            </div>
              ...
              {[
                {
                  ...
                  subtitle: "Spot it",
                  desc: "You receive a suspicious email, text, call, or link that doesn't feel right.",
                ...
                },
                {
                  ...
                  title: "Forward to Us",
                  subtitle: "Send it",
                  desc: "Simply forward the message, screenshot, or file to our secure analysis line.",
                ...
                },
                {
                  ...
                  subtitle: "We check it",
                  desc: "Our AI and human experts analyze the threat and verify authenticity.",
                ...
                },
                {
                  ...
                  desc: "You get a clear, simple answer: safe or dangerous, with next steps.",
                ...
                >
                  <div className="relative bg-card border border-border rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition-all hover:-translate-y-1 h-full">
                    <div
                      className={`absolute top-4 right-4 w-9 h-9 rounded-lg bg-gradient-to-br ${item.color} flex items-center justify-center`}
                    >
                    ...
                    <p
                      className={`text-sm font-semibold mb-3 ${item.subtitleColor}`}
                    >
                      {item.subtitle}
                    </p>
                    <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  We Analyze All Types of Threats
                </h2>
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              ...
              {[
                {
                  ...
                  color: "from-red-500 to-orange-500",
                  description:
                    "Forward suspicious emails for analysis. We check sender authenticity, analyze links, and identify fake logos.",
                },
                {
                  icon: MessageSquare,
                  title: "SMS Scams",
                  color: "from-blue-500 to-cyan-500",
                  description:
                    "Screenshot suspicious texts. We trace senders and verify if messages are legitimate.",
                },
                {
                  icon: Phone,
                  title: "Voice Calls",
                  color: "from-purple-500 to-pink-500",
                  description:
                    "Describe suspicious calls. We identify voice scam patterns and AI-generated voices.",
                },
                {
                  icon: FileText,
                  ...
                  color: "from-amber-500 to-orange-500",
                  description:
                    "Send voicemails for AI analysis. We detect voice cloning and verify authenticity.",
                },
                {
                  icon: LinkIcon,
                  ...
                  description:
                    "Send links before clicking. We safely scan for malware and verify destinations.",
                },
                {
                  icon: QrCode,
                  title: "QR Codes",
                  ...
                  description:
                    "Photo us QR codes. We decode them safely and tell you where they lead.",
                },
                {
                  icon: FileCheck,
                  title: "Documents",
                  ...
                  description:
                    "Upload suspicious PDFs. We check for malware and fake information.",
                },
                {
                  icon: ImageIcon,
                  title: "Social Media",
                  ...
                  description:
                    "Screenshot fake profiles. We verify authenticity and identify scam patterns.",
                },
              ].map((threat, index) => (
                <ScrollReveal
                  key={index}
                ...
                >
                  <div
                    onClick={() =>
                      setExpandedThreat(
                        expandedThreat === threat.title ? null : threat.title,
                      )
                    }
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${threat.color} flex items-center justify-center mb-3`}
                      >
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <p className="text-lg text-foreground max-w-4xl mx-auto mb-2">
                  <strong>
                    The only place where you can get the best AI training.
                  </strong>{" "}
                  Build an AI agency, create automation workflows, or design
                  stunning websites.
                </p>
                <p className="text-accent font-semibold">
                  🚀 Perfect for entrepreneurs, developers, and marketers ready
                  to leverage AI.
                </p>
              </ScrollReveal>
            </div>
            ...
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <p className="text-lg text-foreground max-w-3xl mx-auto">
                  <strong>AI-powered scammers don't just target you.</strong>{" "}
                  They target your entire family.
                </p>
              </ScrollReveal>
            </div>
              ...
              <div className="max-w-4xl mx-auto bg-card border border-border rounded-2xl p-8 md:p-10 shadow-sm">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Included with Family & Premium Plans
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <ScrollReveal>
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                  Real examples of how we've protected our members from
                  devastating losses.
                </p>
              </ScrollReveal>
            </div>
              ...
              <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="p-6 text-center border-2 border-dashed border-primary/30 hover:border-primary/50 transition-all rounded-2xl bg-card"
                    >
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <ScrollReveal>
              ...
              >
                Join 100+ families who trust InVision Network for their digital
                safety
              </p>
              <div className="flex flex-col sm:flex-row gap-4 flex-wrap justify-center">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="bg-white/10 backdrop-blur-md text-white border-white/30 hover:bg-white/20 px-8 py-6 text-lg rounded-2xl"
                >
                  <Link to="/contact">
        ...
        {embeddedPaymentConfig && (
          <EmbeddedPaymentModal
            ...
            onSuccess={() => {
              trackConversion(
                "subscription",
                embeddedPaymentConfig.amount / 100,
              );
            }}
          />
        )}
