            ...
            <Card className="p-6 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-2 text-sm">
                {[
                  ...
                  <button
                    key={i}
                    onClick={() => scrollToSection(`privacy-section-${i + 1}`)}
              ...
              <div className="space-y-12 text-foreground">
                <section id="privacy-section-1">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      ...
                      phone number (from contact forms, account registration,
                      and purchases)
                    </li>
                    <li>
                      <strong>Billing Information:</strong> Credit/debit card
                      details processed securely through Stripe. We never store
                      your full card number
                    </li>
                    <li>
                      <strong>Account Information:</strong> Username, password
                      (encrypted), profile preferences, and communication
                      settings
                    </li>
                    <li>
                      <strong>Veteran Verification:</strong> Military ID, DD-214
                      form, or VA documentation to verify veteran status for
                      discounts
                    </li>
                    <li>
                      <strong>Service Requests:</strong> Information about
                      suspicious items, scams you've encountered, or services
                      you're requesting
                    </li>
                    <li>
                      <strong>Communication Records:</strong> Emails, chat
                      messages, and phone call notes from interactions with our
                      team
                    </li>
                    <li>
                      <strong>Survey Responses:</strong> Feedback, testimonials,
                      and satisfaction ratings you choose to provide
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      ...
                      type and version, operating system, device type, and
                      screen resolution
                    </li>
                    <li>
                      <strong>Usage Data:</strong> Pages visited, time spent on
                      pages, click patterns, scroll depth, and navigation paths
                    </li>
                    <li>
                      <strong>Referral Information:</strong> How you arrived at
                      our website (search engine, social media, referral link)
                    </li>
                    <li>
                      <strong>Cookies & Similar Technologies:</strong> See
                      Section 7 for detailed information about our cookie usage
                    </li>
                    <li>
                      <strong>Location Data:</strong> General geographic
                      location based on IP address (not precise GPS location)
                    </li>
                  </ul>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      ...
                      confirmation, payment status, and fraud prevention signals
                      from Stripe
                    </li>
                    <li>
                      <strong>Social Media:</strong> If you connect social
                      accounts, we may receive your public profile information
                    </li>
                    <li>
                      <strong>Partner Referrals:</strong> Affiliate or partner
                      information if you were referred through a partner program
                    </li>
                  </ul>
                </section>
                ...
                <section id="privacy-section-2">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-4">
                    ...
                    <li>
                      Developing new features and services based on user
                      feedback
                    </li>
                    <li>
                      Conducting research and analysis to enhance user
                      experience
                    </li>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-4">
                    <li>
                      Sending transactional emails (order confirmations,
                      receipts, appointment reminders)
                    </li>
                    <li>
                ...
                <section id="privacy-section-3">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-4">
                    <li>
                      Comply with legal process, court order, or government
                      request
                    </li>
                    <li>
                      Protect the rights, property, or safety of InVision
                      Network, our users, or others
                    </li>
                  ...
                  <p className="text-muted-foreground">
                    If InVision Network is involved in a merger, acquisition, or
                ...
                <section id="privacy-section-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      using industry-standard algorithms. We never store
                      plain-text passwords
                    </li>
                    <li>
                      <strong>Access Controls:</strong> Employee access to
                      personal data is limited and logged
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Payment Security:</strong> Payment processing is
                      handled by PCI-DSS compliant providers (Stripe)
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Secure Storage:</strong> Sensitive documents
                      (veteran IDs) are stored in encrypted, access-controlled
                      storage
                    </li>
                  </ul>
                ...
                <section id="privacy-section-5">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      <strong>Object:</strong> Object to certain types of
                      processing
                    </li>
                    <li>
                ...
                <section id="privacy-section-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      ...
                      account is active, plus 7 years after closure for legal
                      compliance
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Communication Records:</strong> 3 years after the
                      last communication
                    </li>
                    <li>
                      <strong>Veteran Documentation:</strong> Deleted after
                      verification is complete (within 90 days) unless you
                      request we retain it
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Website Analytics:</strong> Anonymized after 26
                      months
                    </li>
                  </ul>
                </section>
                ...
                <section id="privacy-section-7">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    and track information about your use of our Services:
                  </p>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    consent banner or through your browser settings. Note that
                ...
                <section id="privacy-section-9">
                  ...
                  <p className="text-muted-foreground">
                    For users between 13 and 18, parental consent is required to
                    use our Services.
                  </p>
                </section>
                ...
                <section id="privacy-section-10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    InVision Network is based in the United States. If you
                    access our Services from outside the United States, your
                  ...
                  <p className="text-muted-foreground">
                    ...
                    information to the United States and acknowledge that U.S.
                ...
                <section id="privacy-section-11">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-4">
                    <li>
                      <strong>Right to Know:</strong> You can request disclosure
                      of the categories and specific pieces of personal
                      information we've collected about you
                    </li>
                    <li>
                      <strong>Right to Delete:</strong> You can request deletion
                      of your personal information, subject to certain
                      exceptions
                    </li>
                    <li>
                      <strong>Right to Opt-Out:</strong> You can opt-out of the
                ...
                <section id="privacy-section-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    United Kingdom, or Switzerland, you have rights under the
                  ...
                  <p className="text-muted-foreground mb-4">
                    In addition to the rights listed in Section 5, you have the
                ...
                <section id="privacy-section-14">
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    ...
                    <p>
                      <strong>Mail:</strong> InVision Network LLC, Privacy
                      Office, Greater Dayton Area, OH
                    </p>
                  </div>
                  <p className="text-muted-foreground mt-4">
