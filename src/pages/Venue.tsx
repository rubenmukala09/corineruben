      ...
      <div className="container mx-auto px-6 md:px-12 max-w-3xl relative z-10">
        ...
        {isCourtMode ? (
          <>
            ...
            {/* Church Coming Soon teaser */}
            <motion.div initial="hidden" animate="show" variants={fadeUp} transition={{ delay: 0.2 }}
              className="glass-card-strong rounded-3xl p-6 text-center border-primary/20"
            >
          ...
          <>
            {/* Church Mode: Full venue details */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
              {[
