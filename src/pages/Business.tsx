              ...
              >
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    Our AI Receptionist answers every incoming call 24 hours a
                    day, 7 days a week, including holidays, weekends, and after
                    hours. It sounds natural, handles FAQs, and routes urgent
                    calls to the right team member instantly.
                  </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <Card className="p-4 bg-gradient-to-br from-primary/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Your AI receptionist never sleeps. Every call is
                        answered professionally, whether it's 2pm or 2am.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-accent/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        The AI asks the right questions to understand caller
                        needs, qualifying leads before they reach your team.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-success/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Common questions about hours, pricing, and services are
                        answered instantly with accurate responses.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-blue-500/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Built-in spam detection blocks telemarketers and
                        robo-calls before they waste your time.
                      </p>
                    </Card>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-xl p-4">
                    <p className="text-sm leading-relaxed">
                      <strong className="text-primary">The bottom line:</strong>{" "}
                      Many businesses miss valuable calls outside business
                      hours. Each missed call represents potential lost revenue.
                      With our AI Receptionist, you capture every opportunity.
                    </p>
                  </div>
                </div>
              </ExpandableServiceCard>
              ...
              >
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    Our Smart Scheduling system books appointments directly into
                    your calendar. No human intervention required. Clients can
                    book 24/7 through phone, chat, or web, and the AI handles
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    <Card className="p-4 text-center">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Books directly into your calendar with real-time
                        availability.
                      </p>
                    </Card>
                  ...
                  <div className="bg-background border rounded-xl p-4">
                    ...
                    <ol className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Customer calls, chats, or visits your booking page
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary text-white text-xs font-bold flex items-center justify-center">
                        ...
                        <span>
                          AI collects info and checks your live availability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary text-white text-xs font-bold flex items-center justify-center">
                        ...
                        <span>
                          Appointment booked with instant confirmation
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-primary text-white text-xs font-bold flex items-center justify-center">
                        ...
                        <span>
                          Automated reminders go out before the appointment
                        </span>
                      </li>
                    </ol>
                  </div>
              ...
              >
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    Our support bots handle instant FAQ responses, post-service
                    check-ins, review requests, and re-engagement campaigns
                    automatically. Keep your brand top-of-mind without lifting a
                    finger.
                  </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Within 24-48 hours of service, your AI sends
                        personalized follow-ups to ensure satisfaction. Issues
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Happy customers are prompted to leave reviews on Google,
                        Yelp, or Facebook with perfect timing.
                      </p>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Customers who haven't returned receive personalized "we
                        miss you" messages with special offers.
                      </p>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Reach customers via SMS, email, WhatsApp, or website
                        chat. Wherever they prefer.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-success/10 to-emerald-500/10 border border-success/20 rounded-xl p-4">
                    <p className="text-sm leading-relaxed">
                      <strong className="text-success">ROI Fact:</strong>{" "}
                      Customer retention is significantly more cost-effective
                      than acquisition. Businesses that actively follow up see{" "}
                      <strong>
                        substantially higher customer lifetime value
                      </strong>
                      .
                    </p>
                  </div>
              ...
              >
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    Our intake system collects all necessary information before
                    meetings, qualifies leads based on your criteria, and
                    schedules appointments seamlessly, saving hours of
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <Card className="p-4 bg-gradient-to-br from-primary/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Custom forms collect exactly the information you need.
                        Conditional logic shows relevant questions based on
                        responses.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-accent/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Automatically score and prioritize leads based on their
                        responses. High-value prospects get VIP treatment.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-success/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Secure data handling for healthcare, legal, and
                        financial industries. All information encrypted and
                        protected.
                      </p>
                    </Card>
                    ...
                    <Card className="p-4 bg-gradient-to-br from-blue-500/5 to-transparent">
                      ...
                      <p className="text-muted-foreground text-xs">
                        Automatically sync data to your CRM. Works with
                        Salesforce, HubSpot, and most popular platforms.
                      </p>
                    </Card>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-xl p-4">
                    <p className="text-sm leading-relaxed">
                      <strong className="text-primary">Time saved:</strong>{" "}
                      Businesses using automated intake report saving{" "}
                      <strong>10+ hours per week</strong> on administrative
                      tasks. That's 500+ hours per year you can spend on growing
                      your business.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm md:text-base font-medium">
                    Veterans & First Responders receive automatic discount at
                    checkout
                  </span>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
                Custom websites that convert visitors into customers - built for
                security, speed, and success
              </p>
              <div className="max-w-4xl mx-auto bg-gradient-to-r from-accent/10 via-primary/10 to-accent/10 border border-accent/20 rounded-2xl p-6">
                <p className="text-base text-foreground leading-relaxed">
                  ...
                  A slow, outdated, or insecure website drives customers away.
                  With InVision, you get a{" "}
                  <strong>stunning, fast, mobile-optimized website</strong> that
                  builds trust and converts visitors into paying customers.
                  Every site includes SSL security, SEO optimization, and
                  ongoing support.{" "}
                  <span className="text-primary font-semibold">
                    In today's digital world, you can't succeed without a
                    professional online presence. With InVision, you won't have
                    to.
                  </span>
                </p>
              </div>
                ...
                <div className="relative h-full pt-5">
                  ...
                  <Card className="p-6 pt-8 rounded-2xl hover:shadow-medium transition-all hover:-translate-y-1 h-full flex flex-col border-2 border-transparent hover:border-primary/20">
                    ...
                    <p className="text-muted-foreground mb-4 text-sm">
                      Single-page website for campaigns or simple business
                      presence
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "Quick Start",
                          description:
                            "Single-page website for campaigns or simple business presence - 2-Week Delivery",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
              ...
              <ScrollReveal animation="fade-up" delay={150} threshold={0.2}>
                <div className="relative h-full pt-5">
                  ...
                  <Card className="p-6 pt-8 rounded-2xl shadow-[0_8px_30px_hsl(var(--primary)/0.15)] hover:shadow-[0_12px_40px_hsl(var(--primary)/0.2)] transition-all border-2 border-primary h-full flex flex-col">
                    ...
                    <p className="text-muted-foreground mb-4 text-sm">
                      5-10 page professional website with custom features
                    </p>
                    <p className="text-3xl font-bold text-accent mb-4">
                      $4,500
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "Most Popular",
                          description:
                            "5-10 page professional website with custom features, mobile responsive, contact & booking forms",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "Full Featured",
                          description:
                            "Full online store with payment processing, product catalog, inventory management, and security",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Elevate your website with professional services designed to
                ...
                <div className="mt-10 text-center">
                  <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-primary/10 to-accent/10 rounded-full border border-primary/20">
                    ...
                    <span className="text-sm font-medium">
                      All add-ons can be bundled with your website for special
                      pricing
                    </span>
                    <Button
                      variant="link"
                      ...
                      onClick={() => {
                        setSelectedInquiry({
                          ...
                          tier: "Custom Bundle",
                          description:
                            "Let us create a custom package with your chosen add-ons and services",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
                Comprehensive protection for your website - security monitoring,
                backups, support, and performance optimization
              </p>
              <div className="max-w-4xl mx-auto bg-gradient-to-r from-success/10 via-primary/10 to-success/10 border border-success/20 rounded-2xl p-6 mb-4">
                <p className="text-base text-foreground leading-relaxed">
                  ...
                  In today's world, cyber threats, data loss, and downtime can
                  cost you thousands of dollars and irreparable damage to your
                  reputation. With InVision Website Insurance, you get{" "}
                  <strong>
                    24/7 protection, instant backups, and expert support
                  </strong>{" "}
                  so you can focus on growing your business while we keep your
                  site safe, fast, and always online.{" "}
                  <span className="text-primary font-semibold">
                    Don't leave your investment unprotected. With InVision,
                    you're never alone.
                  </span>
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto pt-10">
                  ...
                  <Card className="p-6 rounded-2xl hover:shadow-medium transition-all hover:-translate-y-1 h-full flex flex-col pt-8 min-h-[480px]">
                    <div className="text-center flex-1 flex flex-col">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          trackButtonClick(
                            "Subscribe Now - Website Insurance Essential",
                            "Website Insurance",
                          );
              ...
              <ScrollReveal animation="fade-up" delay={100}>
                <div className="relative pt-5 min-h-[520px]">
                  <div
                    className="absolute -top-1 left-1/2 -translate-x-1/2 bg-gradient-to-r from-primary to-accent text-white px-5 py-2 rounded-full text-sm font-bold tracking-wider shadow-lg animate-pulse whitespace-nowrap z-20"
                  ...
                  <Card className="p-6 rounded-2xl border-2 border-primary shadow-[0_8px_30px_rgba(139,92,246,0.15)] hover:shadow-[0_12px_40px_rgba(139,92,246,0.2)] transition-all h-full flex flex-col pt-8 min-h-[480px]">
                    <div className="text-center flex-1 flex flex-col">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          trackButtonClick(
                            "Subscribe Now - Website Insurance Professional",
                            "Website Insurance",
                          );
                          setWebsiteInsuranceOpen(true);
                        }}
                  ...
                  <Card className="p-6 rounded-2xl border-2 border-amber-500/50 hover:shadow-medium transition-all hover:-translate-y-1 h-full flex flex-col pt-8 min-h-[480px]">
                    <div className="text-center flex-1 flex flex-col">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          trackButtonClick(
                            "Subscribe Now - Website Insurance Enterprise",
                            "Website Insurance",
                          );
                          setWebsiteInsuranceOpen(true);
                        }}
                  ...
                  <Card className="p-6 rounded-2xl border-2 border-dashed border-primary/40 hover:border-primary transition-all hover:-translate-y-1 h-full flex flex-col bg-gradient-to-br from-background to-primary/5 pt-8 min-h-[480px]">
                    <div className="text-center flex-1 flex flex-col">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          trackButtonClick(
                            "Subscribe Now - Website Insurance Custom",
                            "Website Insurance",
                          );
                          setWebsiteInsuranceOpen(true);
                        }}
            ...
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/20 rounded-2xl p-6">
                <p className="text-base text-foreground leading-relaxed">
                  ...
                  Our AI agents work around the clock, answering calls, booking
                  appointments, and following up with leads while you sleep. In
                  today's competitive market,{" "}
                  <strong>
                    businesses that respond faster win more customers
                  </strong>
                  . With InVision AI, you never miss an opportunity.{" "}
                  <span className="text-accent font-semibold">
                    Your competitors are already using AI. Can you afford to
                    fall behind?
                  </span>
                </p>
              </div>
                ...
                <div className="relative pt-5">
                  ...
                  <Card className="p-6 md:p-8 pt-6 active:scale-98 hover:shadow-strong transition-all hover:-translate-y-2 h-full flex flex-col border-2 border-transparent hover:border-primary/20">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">
                      AI Receptionist & Intake Agent
                    </h3>
                    <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                      Answer calls/chats 24/7, book appointments, route leads to
                      the right person
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "START HERE",
                          description:
                            "Answer calls/chats 24/7, book appointments, route to the right person, and never miss a lead.",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
              ...
              <ScrollReveal animation="scale-in" delay={200}>
                <div className="relative h-full pt-5">
                  ...
                  <Card className="p-6 md:p-8 pt-6 active:scale-98 border-2 border-primary shadow-[0_8px_30px_hsl(var(--primary)/0.15)] hover:shadow-[0_12px_40px_hsl(var(--primary)/0.2)] transition-all hover:-translate-y-2 h-full flex flex-col">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 mt-2">
                      Follow-Up Automation System
                    </h3>
                    <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                      Automated email/SMS campaigns, lead nurturing to convert
                      more prospects
                    </p>
                    <p className="text-3xl md:text-4xl font-bold text-accent mb-4 md:mb-6">
                      $12,500
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "MOST POPULAR",
                          description:
                            "Automated email/SMS campaigns, lead nurturing, and multi-channel follow-ups to 10x your leads.",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
              ...
              <ScrollReveal animation="slide-right" delay={400}>
                <div className="relative h-full pt-5">
                  ...
                  <Card className="p-6 md:p-8 pt-6 border-2 border-accent active:scale-98 hover:shadow-strong transition-all hover:-translate-y-2 h-full flex flex-col">
                    ...
                    <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">
                      Multi-system operations with enterprise-grade integrations
                    </p>
                    <p className="text-3xl md:text-4xl font-bold text-accent mb-4 md:mb-6">
                      $25,000+
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSelectedInquiry({
                          ...
                          tier: "ENTERPRISE",
                          description:
                            "Full custom-built AI automation for multi-system operations with priority support and complete customization.",
                        });
                        setInquiryDialogOpen(true);
                      }}
                    >
        ...
        <section id="insurance" className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
                Protect your AI investment with ongoing maintenance, updates,
                and support - regardless of where you purchased your agent.
              </p>
              <div className="max-w-4xl mx-auto bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border border-amber-500/20 rounded-2xl p-6">
                <p className="text-base text-foreground leading-relaxed">
                  <strong className="text-amber-600 dark:text-amber-400">
                    AI technology evolves fast. Without proper care, your
                    investment becomes obsolete.
                  </strong>{" "}
                  Our AI Services Insurance ensures your agents stay{" "}
                  <strong>
                    updated, secure, and performing at peak efficiency
                  </strong>
                  . From security patches to performance optimization, we handle
                  everything so your AI keeps delivering results.{" "}
                  <span className="text-primary font-semibold">
                    Don't let your AI investment go to waste. Protect it with
                    InVision, because success requires ongoing commitment.
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 mb-10">
              <Label
                ...
                className={`text-lg font-semibold ${!isYearly ? "text-primary" : "text-muted-foreground"}`}
              >
                Monthly
              </Label>
              <Switch
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 items-stretch">
              ...
              <div className="relative h-full min-h-[480px]">
                ...
                <Card className="p-6 rounded-2xl border-border/50 hover:shadow-medium transition-all hover:-translate-y-1 h-full flex flex-col min-h-[440px]">
                  ...
                  <p
                    key={isYearly ? "yearly-199" : "monthly-199"}
                    className="text-3xl font-bold gradient-text-primary mb-2 price-flip"
                  >
                    {getInsurancePrice(199).display}
                    <span className="text-base text-muted-foreground">
                      {getInsurancePrice(199).period}
                    </span>
                  </p>
                  {isYearly && (
                  ...
                  <Button
                    onClick={() => {
                      trackButtonClick(
                        "Subscribe - Basic Care",
                        "Business Insurance",
                      );
                      trackConversion("insurance_basic", 199);
                      handleSubscribe(
                        "price_1SjwUMJ8osfwYbX7hBE9RiPI",
              ...
              <div className="relative h-full min-h-[480px]">
                <div
                  className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-primary to-accent text-primary-foreground px-4 py-2 rounded-full text-sm font-bold tracking-wider shadow-lg z-20 whitespace-nowrap animate-pulse"
                  style={{ animationDuration: "3s" }}
                >
                  ⭐ MOST POPULAR
                </div>
                <Card className="p-6 border-2 border-primary rounded-2xl shadow-[0_8px_30px_rgba(139,92,246,0.15)] hover:shadow-[0_12px_40px_rgba(139,92,246,0.2)] transition-all h-full flex flex-col min-h-[440px]">
                  ...
                  <p
                    key={isYearly ? "yearly-399" : "monthly-399"}
                    className="text-3xl font-bold gradient-text-primary mb-2 price-flip"
                  >
                    {getInsurancePrice(399).display}
                    <span className="text-base text-muted-foreground">
                      {getInsurancePrice(399).period}
                    </span>
                  </p>
                  {isYearly && (
                    <p className="text-sm text-success mb-3 animate-fade-in">
                  ...
                  <Button
                    onClick={() => {
                      trackButtonClick(
                        "Subscribe - Standard Care",
                        "Business Insurance",
                      );
                      trackConversion("insurance_standard", 399);
                      handleSubscribe(
                        "price_1SjwUOJ8osfwYbX7uyyCGLES",
                        "AI Service Insurance",
                        "Standard Care",
                        39900,
                        "default",
              ...
              <div className="relative h-full min-h-[480px]">
                ...
                <Card className="p-6 rounded-2xl border-amber-500/30 hover:shadow-medium transition-all hover:-translate-y-1 h-full flex flex-col min-h-[440px]">
                  ...
                  <p
                    key={isYearly ? "yearly-799" : "monthly-799"}
                    className="text-3xl font-bold gradient-text-primary mb-2 price-flip"
                  >
                    {getInsurancePrice(799).display}
                    <span className="text-base text-muted-foreground">
                      {getInsurancePrice(799).period}
                    </span>
                  </p>
                  {isYearly && (
                    <p className="text-sm text-success mb-3 animate-fade-in">
            ...
            <div className="mt-16">
              <Card className="max-w-5xl mx-auto p-8 md:p-10 bg-background border rounded-2xl">
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Wherever you purchased your AI, we can help. We fix,
                    optimize, secure, and develop AI systems from any platform
                    worldwide.
                  </p>
                </div>
              ...
              <Card className="p-8 md:p-10 bg-background">
                {activeConsultingTab === "thinking" && (
                  <div className="text-center animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
                      Not sure if AI is right for your business? We'll help you
                      explore the possibilities, understand the costs, and see
                      if AI can genuinely help you grow. No pressure, no sales
                ...
                {activeConsultingTab === "buying" && (
                  <div className="text-center animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
                      Found an AI tool you want to buy? Before you commit, let
                      us analyze it. We'll check for hidden costs, security
                      risks, data privacy concerns, and whether it can actually
                      deliver the ROI the vendor promises.
                    </p>
                    <ul className="text-left max-w-md mx-auto space-y-2 mb-8">
                      <li className="flex items-center gap-2 text-sm">
                ...
                {activeConsultingTab === "bought" && (
                  <div className="text-center animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
                      Already using AI but not sure if it's secure or performing
                      well? We'll audit your current AI system to find
                      vulnerabilities, optimize performance, and ensure your
                      data isn't at risk.
                    </p>
                    <ul className="text-left max-w-md mx-auto space-y-2 mb-8">
                      <li className="flex items-center gap-2 text-sm">
                ...
                {activeConsultingTab === "leaving" && (
                  <div className="text-center animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
                      AI not working out? No judgment here. We'll help you
                      safely exit your current AI system, migrate your data, and
                      find alternative solutions that actually work for your
                      business.
                    </p>
                    <ul className="text-left max-w-md mx-auto space-y-2 mb-8">
                      <li className="flex items-center gap-2 text-sm">
        ...
        <section className="py-20 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-14">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Why Choose InVision for Your AI
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                <ScrollReveal animation="fade-up" delay={0} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-primary">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We audit data flows, enforce least-privilege access, and
                      vet every vendor. Your data stays protected.
                    </p>
                  </Card>
                </ScrollReveal>
                ...
                <ScrollReveal animation="fade-up" delay={100} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-accent">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We train AI on YOUR data, test thoroughly, and optimize
                      for 30 days. Real results, not empty promises.
                    </p>
                  </Card>
                </ScrollReveal>
                ...
                <ScrollReveal animation="fade-up" delay={200} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-success">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We build on open standards. Want to take it in-house
                      later? You can. Your AI, your data, your choice.
                    </p>
                  </Card>
                </ScrollReveal>
                ...
                <ScrollReveal animation="fade-up" delay={300} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-amber-500">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Your team gets documentation they can actually understand.
                      No tech jargon, just clarity.
                    </p>
                  </Card>
                </ScrollReveal>
                ...
                <ScrollReveal animation="fade-up" delay={400} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-cyan-500">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Most AI solutions go live in 2-4 weeks. We move fast
                ...
                <ScrollReveal animation="fade-up" delay={500} threshold={0.2}>
                  <Card className="p-6 h-full hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 border-t-rose-500">
                    ...
                    <p className="text-muted-foreground text-sm">
                      We don't disappear after launch. Continuous support,
                      updates, and optimization as your business grows.
                    </p>
                  </Card>
                </ScrollReveal>
              </div>
              ...
              <Card className="p-8 bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border-primary/20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                  <div>
                    <p className="text-4xl font-black gradient-text-primary mb-1">
                      15+
                    </p>
              ...
              <div className="max-w-2xl mx-auto">
                <Card className="p-12 border-2 border-dashed border-primary/50 bg-primary/5">
                  <div className="flex flex-col items-center text-center gap-4">
                    <div className="text-5xl" style={{ fontSize: "48px" }}>
                      💼
                    </div>
