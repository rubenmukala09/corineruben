...
export const ROLE_CONFIGS: Record<UserRole, RoleConfig> = {
  ...
  'secretary': {
    ...
    permissions: ['view_clients', 'manage_clients', 'view_messages', 'reply_messages', 'view_calendar', 'manage_appointments'],
    redirectTo: '/admin/clients/businesses'
  },
  'training_coordinator': {
    role: 'training_coordinator',
    displayName: 'Training Coordinator',
    permissions: ['view_training', 'manage_training', 'view_individual_clients', 'manage_scamshield', 'create_content', 'view_training_analytics'],
    redirectTo: '/admin/content/articles'
  },
  'business_consultant': {
    role: 'business_consultant',
    displayName: 'Business Consultant',
    permissions: ['view_business_clients', 'manage_business_clients', 'view_services', 'create_proposals', 'manage_ai_services'],
    redirectTo: '/admin/clients/businesses'
  },
  'support_specialist': {
    role: 'support_specialist',
    displayName: 'Support Specialist',
    permissions: ['view_all_clients', 'view_tickets', 'manage_tickets', 'view_logs', 'access_technical_docs'],
    redirectTo: '/admin'
  },
  'staff': {
    role: 'staff',
