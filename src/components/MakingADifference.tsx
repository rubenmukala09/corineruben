...
const MakingADifference = () => {
  ...
  const [donationType, setDonationType] = useState<
    "sponsor" | "monthly" | "corporate" | "general"
  >("general");
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Your enrollment powers safety education and community support
              programs nationwide.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Active duty, veterans, reservists, and first responders
                  receive special recognition with our standing discount
                  program.
                </p>
            ...
            <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300 border-2 border-primary/20">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Sponsor training seats for caregivers and provide specialized
                  scam‑prevention resources during hospital stays.
                </p>
            ...
            <Card className="relative overflow-hidden group hover:shadow-lg transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  100% of donations fund scholarships, caregiver training
                  programs, and community safety workshops.
                </p>
                <Button
                  onClick={() => openDonationModal("general")}
                  className="w-full"
