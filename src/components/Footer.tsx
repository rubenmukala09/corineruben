          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-10">
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={link.to}>
                    <Link to={link.to} className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["ScamShield Protection", "Safety Audit", "Web Design", "AI Automation"].map((label, i) => (
                  <li key={i}>
                    <Link to="/services" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Zoom Classes", "In-Person", "Group Bookings", "Gift Certificates"].map((label, i) => (
                  <li key={i}>
                    <Link to="/training" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/contact" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">Emergency Help</Link></li>
                <li>
                  <button 
                    onClick={() => {
                    ...
                    className="flex items-center gap-1.5 min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/refund-policy" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">Refund Policy</Link></li>
                <li><Link to="/cookie-policy" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">Cookie Policy</Link></li>
                <li><Link to="/acceptable-use" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">Acceptable Use</Link></li>
                <li><Link to="/disclaimer" className="inline-block min-h-[24px] py-2 text-base text-white/60 hover:text-white transition-colors">Disclaimer</Link></li>
              </ul>
            </div>
          </div>
