  ...
  return (
    <section className="py-8 md:py-12 lg:py-16 bg-background">
      <div className="w-full">
        ...
        {/* Google Maps Embed - Full Width Rectangular */}
        <div className="w-full">
          <div className="relative w-full h-[300px] md:h-[350px] lg:h-[400px] border-y-2 border-primary/20 shadow-lg overflow-hidden">
            <iframe
