...
export const AIBusinessPromo = () => {
  return (
    <section
      className="relative py-12 lg:py-16 bg-gradient-to-br from-background via-white to-lavender-50/20 dynamic-gradient-overlay"
    ...
    >
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h2
            id="business-heading"
            className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground leading-tight mb-3"
        ...
        >
          {services.map((service) => (
            ...
            >
              ...
              <div
                className="w-12 h-12 rounded-xl bg-white/60 dark:bg-card/60 backdrop-blur-sm flex items-center justify-center mb-4 border border-white/50"
                aria-hidden="true"
              >
              ...
              <Link
                to="/business"
                className="inline-flex items-center text-primary font-semibold text-sm hover:text-accent transition-colors"
              >
                Learn More
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-foreground/60 leading-relaxed text-sm">
              With more than 7 years of expertise in design and digital
              transformation, we are committed to providing our customers with
            ...
            <div className="flex items-end gap-3 py-2">
              <div
                className="text-5xl font-black text-[#18305A] leading-none"
              ...
              <div className="pb-1">
                ...
                <div className="text-base font-bold text-[#18305A]">
                  Experience
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #BB81B5 0%, #F8926A 100%)",
                }}
              >
              ...
              <div className="text-foreground/50 text-sm">
                <span className="font-medium text-[#18305A]">
                  +1 {SITE.phone.display}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div
              className="absolute -inset-2 rounded-2xl bg-gradient-to-br from-lavender-200/40 via-coral-100/30 to-white opacity-90"
              aria-hidden="true"
            />
            ...
            <div className="absolute -bottom-2 -left-2 widget-premium micro-scale">
              <div
                className="text-xl font-black text-coral-500"
                style={{ fontFamily: "'Lora', serif" }}
              >
                340%
              </div>
            ...
            <div className="absolute top-1.5 right-1.5 bg-white/95 rounded-full shadow-md px-2 py-0.5 border border-lavender-200/50">
              <div className="flex items-center gap-1" aria-label="AI Powered">
                <Sparkles
                  className="w-2.5 h-2.5 text-lavender-500"
                  aria-hidden="true"
                />
                <span className="text-xs font-bold text-[#18305A]">
                  AI Powered
                </span>
              </div>
            </div>
