...
const services = [
  {
    ...
    desc: "Identify AI-powered scams before they strike",
  },
  {
    icon: Shield,
    title: "4-Step Protection",
    desc: "Proven methodology for digital safety",
  },
  {
    icon: Target,
    title: "Protection Tiers",
    desc: "Customized security for your needs",
  },
  {
    icon: Eye,
...
export const WorkshopsPromo = () => {
  ...
  return (
    <section
      className="relative py-12 lg:py-16 bg-gradient-to-br from-background via-white to-lavender-50/20 overflow-hidden dynamic-gradient-overlay"
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          ...
          <div className="relative" ref={mediaRef}>
            ...
            <div className="relative depth-layers micro-tilt-3d subtle-3d-surface">
              <div
                className="absolute -inset-4 rounded-2xl glass-light"
                aria-hidden="true"
              />
                ...
                {videoError && (
                  ...
                  >
                    <div className="w-16 h-16 rounded-full glass-light flex items-center justify-center shadow-3d micro-pulse">
                      <Play
                        className="w-6 h-6 text-coral-500 ml-1"
                        fill="currentColor"
                      />
                    </div>
                  </button>
          ...
          <div className="space-y-5">
            ...
            <h2
              ...
              className="text-3xl md:text-4xl font-black text-[#18305A] leading-tight"
            ...
            <p className="text-base text-foreground/60 leading-relaxed">
              Scammers now use deepfakes and voice cloning. Our expert-led
              workshops teach you to recognize and stop these sophisticated
              threats.
            </p>
            ...
            <div className="flex items-center gap-6 py-2">
              <div className="text-center">
                <div
                  className="text-3xl font-black text-[#18305A]"
              ...
              <div className="text-center">
                <div
                  className="text-3xl font-black text-coral-500"
                  style={{ fontFamily: "'Lora', serif" }}
                >
                  100%
                </div>
            ...
            >
              {services.map((service, i) => (
                ...
                >
                  <CheckCircle
                    className="w-4 h-4 text-coral-500 mt-0.5 flex-shrink-0"
                    aria-hidden="true"
                  />
