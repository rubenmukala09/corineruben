...
const steps = [
  ...
  },
  {
    ...
    description:
      "We analyze your digital footprint and secure vulnerabilities.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg text-sm font-semibold uppercase tracking-wider mb-4 skeuo-badge">
            <span
              className="w-2 h-2 rounded-full bg-gradient-to-r from-coral-400 to-lavender-500"
              aria-hidden="true"
            />
          ...
          <p className="text-foreground/60 text-base max-w-xl mx-auto">
            Our streamlined process makes getting protected easy and
            stress-free.
          </p>
        </div>
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              {/* Step number badge */}
              <div
                className={`absolute -top-2 -right-2 w-7 h-7 bg-gradient-to-br ${step.gradient} text-white rounded-lg flex items-center justify-center font-bold text-xs shadow-md`}
              >
                {step.step}
              </div>
              ...
              {/* Icon */}
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.gradient} flex items-center justify-center shadow-sm mx-auto mb-4`}
                aria-hidden="true"
              >
