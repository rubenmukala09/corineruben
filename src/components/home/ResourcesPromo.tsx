...
export const ResourcesPromo = () => {
  return (
    <section
      className="relative py-10 lg:py-14 overflow-hidden dynamic-gradient-overlay"
      style={{
        background:
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border mb-4 shadow-sm bg-coral-50/50 border-coral-200/50 skeuo-badge">
              ...
              <span className="text-sm font-semibold uppercase tracking-wide text-[#18305A]">
                Resources
              </span>
            </div>
            ...
            <p className="text-base text-foreground/70">
              From insurance coverage to free educational materials. Everything
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-10">
          ...
          <div className="relative depth-layers micro-tilt-3d subtle-3d-surface">
            ...
            <div className="absolute bottom-4 left-4 right-4 widget-premium micro-scale">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-xs font-medium text-foreground/60 mb-0.5">
                    Resources Available
                  </div>
                  <div
                    className="text-2xl font-black text-[#18305A]"
                ...
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center shadow-3d"
                  style={{
                    background:
          ...
          >
            {resources.map((resource, i) => (
              ...
              >
                <div
                  className="h-full p-4 rounded-xl glass-light shadow-3d hover-depth micro-scale flex items-center gap-4 micro-tilt-3d subtle-3d-surface"
                  style={{ borderLeft: `4px solid ${resource.color}` }}
                >
                  <div className="flex-shrink-0">
                    <div
                      className="w-11 h-11 rounded-lg flex items-center justify-center shadow-3d float-3d"
                      style={{
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <h3
                        className="text-base font-bold text-[#18305A]"
                        style={{ fontFamily: "'Lora', serif" }}
                      >
                        {resource.title}
                      </h3>
                      <span
                        className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase glass-subtle"
                        style={{
                  ...
                  <ArrowRight
                    className="w-4 h-4 text-foreground/40 flex-shrink-0 micro-rotate"
                    aria-hidden="true"
                  />
                </div>
              </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-bold text-[#18305A]">
                Free Emergency Anti-Scam Scripts
              </div>
              <div className="text-sm text-foreground/50">
                IRS • Tech Support • Grandparent • Bank Fraud
              </div>
            </div>
          </div>
          <Button
