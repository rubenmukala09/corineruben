...
const teamMembers = [
  ...
  { name: "Marcus", role: "Security Specialist", image: teamSecuritySpecialist },
];
 
 export const CommunityImpact = () => {
   return (
    <section className="relative py-10 lg:py-14 overflow-hidden" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #faf9f7 50%, #fff5f0 100%)' }} aria-labelledby="team-heading">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-8">
         ...
         {/* Team Cards */}
        <div className="grid md:grid-cols-3 gap-4 mb-10" role="list" aria-label="Team members">
            ...
            <div 
             ...
             >
              ...
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden mb-4 shadow-lg border-2 border-white">
                ...
                />
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#18305A]/50 via-transparent to-transparent" aria-hidden="true" />
          ...
          <div className="relative">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl border-2 border-white">
               <img 
                 ...
                 className="w-full h-full object-cover"
               />
              <div className="absolute inset-0 bg-gradient-to-t from-[#18305A]/30 via-transparent to-transparent" aria-hidden="true" />
             </div>
            ...
            <div className="absolute -bottom-3 -right-3 bg-white/70 backdrop-blur-xl rounded-xl shadow-lg px-5 py-3 border border-white/50">
              <div className="text-xs font-medium text-foreground/60">Veteran-Owned</div>
              <div className="text-xl font-black text-[#18305A]">Ohio Based</div>
            </div>
          </div>
            ...
            <div className="space-y-3 pt-2" role="list" aria-label="Our values">
               {values.map((value, i) => (
                <div 
                 ...
                 >
                  <div className="w-10 h-10 rounded-full bg-white/60 backdrop-blur-xl border border-white/40 shadow-md flex items-center justify-center" aria-hidden="true">
                    <value.icon className="w-4 h-4 text-coral-500" />
                   </div>
                  <span className="font-medium text-[#18305A] text-sm">{value.title}</span>
                </div>
               ))}
             </div>
