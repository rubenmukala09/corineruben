...
const scamAlerts = [
  {
    ...
    description:
      "Criminals clone voices of loved ones using AI to request emergency funds.",
    trend: "+340%",
  ...
  },
  {
    ...
    description:
      "Fraudulent emails mimicking IRS, SSA, or Medicare demanding immediate action.",
    trend: "+180%",
  ...
  },
  {
    ...
    description:
      "Requests for gift cards, wire transfers, or cryptocurrency are always scams.",
    trend: "+95%",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg mb-4">
            ...
            <span className="text-sm font-semibold text-[#18305A]">
          ...
          <h2
            id="alerts-heading"
            className="text-3xl md:text-4xl font-black text-[#18305A] mb-3"
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-10">
          <div className="relative">
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center gap-2 bg-white/70 backdrop-blur-xl rounded-lg p-2 border border-white/50">
              <div
                className="w-8 h-8 rounded-lg bg-coral-500 flex items-center justify-center"
                aria-hidden="true"
              >
                <TrendingUp className="w-4 h-4 text-white" />
              </div>
              <div>
                <div className="text-[#18305A] font-bold text-xs">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-3 left-3 right-3 flex items-center gap-2 bg-white/70 backdrop-blur-xl rounded-lg p-2 border border-white/50">
              <div
                className="w-8 h-8 rounded-lg bg-lavender-500 flex items-center justify-center"
                aria-hidden="true"
              >
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div
            className="space-y-3"
            role="list"
            aria-label="Current scam alerts"
          >
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-xl p-5 border border-white/50 shadow-md">
              ...
              >
                {quickTips.map((tip, index) => (
                  ...
                  >
                    <div
                      className="w-5 h-5 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center flex-shrink-0"
                      aria-hidden="true"
                    >
              ...
              <div className="relative z-10 p-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button
                    ...
                    variant="secondary"
                    size="lg"
                    className="h-10 px-5 text-sm font-bold rounded-full"
                  >
