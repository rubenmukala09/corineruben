...
const services = [
  {
    ...
    description:
      "Advanced protection against AI-powered scams and fraud attempts.",
  ...
  },
  {
    ...
    title: "AI Detection",
    description:
      "Smart technology that identifies threats before they reach you.",
...
export const ServicesShowcase = () => {
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <IllustrationLines
        variant="circuit"
        className="bottom-20 right-10 opacity-50"
      />
              ...
              <Link to={service.link} className="block">
                <div className="bg-white rounded-3xl overflow-hidden border border-white/50 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-400 ease-out hover:translate-y-[-8px] hover:scale-[1.02] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.12)] relative">
                  ...
                  <div className="relative p-6 pb-0 pt-12">
                    ...
                    {/* Decorative lines */}
                    <svg
                      className="absolute top-8 left-4 w-12 h-12 opacity-30 group-hover:opacity-50 transition-opacity"
                      viewBox="0 0 48 48"
                    >
                      <path
                        d="M4 24 C 16 8, 32 8, 44 24"
                        stroke="currentColor"
                        strokeWidth="2"
                        fill="none"
