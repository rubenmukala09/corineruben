...
const coreValues = [
  {
    ...
    description:
      "Every family deserves safety from digital threats. We make enterprise-grade security accessible to everyone.",
  ...
  },
  {
    ...
    description:
      "Our systems learn and adapt faster than scammers can evolve, keeping you one step ahead.",
  ...
  },
  {
    ...
    description:
      "From startups to enterprises, we provide comprehensive cybersecurity training and protection.",
  ...
  },
  {
    ...
    description:
      "We train individuals, families, companies, and organizations to recognize and prevent threats.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            In today's world, scammers use AI to create convincing attacks that
            fool even the smartest people.
            <strong className="text-foreground">
              {" "}
              Without protection, it's not if you'll be targeted. It's when.
            </strong>
          </p>
          <DottedPattern
            ...
            >
              <div className="h-full bg-white rounded-3xl p-8 border border-white/50 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-400 ease-out hover:translate-y-[-8px] hover:scale-[1.02] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.12)] relative overflow-hidden">
                <div
                  ...
                  style={{
                    borderTop: "24px solid hsl(var(--primary) / 0.1)",
          ...
          <div className="relative z-10 p-8 md:p-12 border border-white/10 rounded-3xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  Many fraud cases go unreported, and AI-powered scams are
                  rising quickly. Don't become a statistic.
                </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${stat.gradient} flex items-center justify-center mx-auto mb-3`}
                    >
