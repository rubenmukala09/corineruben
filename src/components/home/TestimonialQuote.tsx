          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-border/50">
              ...
              <p className="text-lg text-muted-foreground mb-4">
                We're just getting started! Be one of our first clients and
                share your experience.
              </p>
              <p className="text-sm text-muted-foreground">
                Your feedback helps other families make informed decisions about
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-300 ${
                      index === currentIndex
                        ? "bg-primary w-8"
                        : "bg-muted w-2 hover:bg-primary/30"
                    }`}
