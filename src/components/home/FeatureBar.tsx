...
const features = [
  {
    ...
    description:
      "Learn to identify and prevent AI-powered scams with our hands-on workshops.",
  },
  {
    icon: Award,
    title: "Proven Protection",
    description:
      "Industry-recognized security solutions backed by certified cybersecurity professionals.",
  },
  {
    icon: Shield,
    title: "24/7 Monitoring",
    description:
      "Round-the-clock threat detection and immediate response to protect your family.",
  },
  {
    icon: GraduationCap,
    title: "Family Education",
    description:
      "Empowering every family member with the knowledge to stay safe online.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Experience the difference of professional, veteran-supporting
            ...
            >
              ...
              <div className="relative inline-block mb-6">
                <HexagonIcon
                  size="lg"
                  animated
                  className="mx-auto group-hover:bg-primary/20 transition-colors"
                >
                  <feature.icon
