...
const testimonials = [
  {
    ...
    quote:
      "Clear guidance and calm, respectful support throughout the process.",
    rating: 5,
...
export const PremiumGlassmorphismWidgets = () => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #ffffff 0%, #faf9f7 30%, #fff5f0 60%, #faf5fa 100%)",
      }}
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(248,146,106,0.4) 0%, transparent 60%)",
          filter: "blur(80px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(187,129,181,0.5) 0%, transparent 60%)",
          filter: "blur(100px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, #BB81B5 0%, #18305A 100%)",
        }}
        animate={{ y: [0, 15, 0] }}
        transition={{
          duration: 8,
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2
            className="text-4xl md:text-5xl lg:text-6xl font-black text-[#18305A] leading-tight mb-4"
          ...
          >
            ...
            , Real{" "}
            <span className="bg-gradient-to-r from-lavender-500 to-[#18305A] bg-clip-text text-transparent">
              Results
            </span>
          </h2>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="relative aspect-[4/5] rounded-[40px] overflow-hidden shadow-2xl shadow-coral-400/20">
              ...
              >
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-coral-500" />
                  <span className="text-sm font-bold text-[#18305A]">
                    Trusted
                  </span>
                </div>
              </motion.div>
          ...
          <div className="lg:col-span-7 grid gap-6">
              ...
              {floatingStats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div
                      className="text-3xl font-black text-[#18305A] mb-1"
                      style={{ fontFamily: "'Lora', serif" }}
                    >
                      {stat.value}
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {securityFeatures.map((feature, i) => (
                ...
                >
                  ...
                  <div
                    className={`w-14 h-14 mx-auto rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center shadow-lg mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                  >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-bold text-lg text-[#18305A]">
            ...
            <motion.div
              ...
              style={{
                background: "linear-gradient(135deg, #18305A 0%, #2a4a7a 100%)",
              }}
            >
