...
// Note: Update these stats periodically with real metrics from database
 ...
 const securityFeatures = [
   { icon: Lock, title: "End-to-End Protection", gradient: "from-coral-400 to-coral-600" },
   { icon: Eye, title: "24/7 Monitoring", gradient: "from-lavender-400 to-lavender-600" },
   { icon: Bell, title: "Instant Alerts", gradient: "from-blue-400 to-blue-600" },
   { icon: Fingerprint, title: "Identity Shield", gradient: "from-emerald-400 to-emerald-600" },
 ];
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-[#18305A] leading-tight mb-3 md:mb-4 px-2"
         ...
         <div className="grid lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10 xl:gap-12">
           ...
           >
             <div className="relative aspect-[4/5] rounded-2xl sm:rounded-3xl lg:rounded-[40px] overflow-hidden shadow-2xl shadow-coral-400/20 hover:shadow-coral-400/30 transition-all duration-300">
               ...
               <motion.div
                 className="absolute bottom-3 left-3 right-3 sm:bottom-6 sm:left-6 sm:right-6 glass-enhanced rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-float"
                 initial={{ opacity: 0, y: 20 }}
                 whileInView={{ opacity: 1, y: 0 }}
               ...
               >
                 <div className="flex items-center justify-between">
                   <div>
                     ...
                     <div className="text-[#18305A] text-2xl sm:text-3xl font-black" style={{ fontFamily: "'Lora', serif" }}>100+</div>
                   </div>
               ...
               <motion.div
                 className="absolute top-3 right-3 sm:top-6 sm:right-6 glass-enhanced rounded-full shadow-float px-3 py-1.5 sm:px-4 sm:py-2"
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
                {floatingStats.map((stat, i) => (
                  ...
                  >
                    <div
                      className="w-14 h-14 sm:w-16 sm:h-16 mx-auto rounded-xl sm:rounded-2xl mb-3 sm:mb-4 flex items-center justify-center shadow-lg"
                      style={{ background: `linear-gradient(135deg, ${stat.color}40 0%, ${stat.color}60 100%)` }}
                    >
                      <stat.icon className="w-7 h-7 sm:w-8 sm:h-8" style={{ color: stat.color }} />
                    </div>
                    <div className="text-2xl sm:text-3xl md:text-4xl font-black text-[#18305A] mb-1.5 sm:mb-2" style={{ fontFamily: "'Lora', serif" }}>
                      {stat.value}
                    </div>
            ...
            >
              <div className="flex flex-col md:flex-row items-center md:justify-between gap-5 sm:gap-6 text-center md:text-left">
                <div className="flex-1">
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-[#18305A] mb-2 leading-tight" style={{ fontFamily: "'Lora', 'Rubik', serif" }}>
                ...
                <Link
                  to="/training#pricing"
                  className="inline-flex items-center justify-center gap-2.5 sm:gap-3 px-6 py-3.5 sm:px-8 sm:py-4 rounded-full text-white text-sm sm:text-base font-bold shadow-2xl hover:shadow-coral-500/30 hover:scale-105 active:scale-100 transition-all duration-300 whitespace-nowrap w-full md:w-auto min-h-[48px]"
