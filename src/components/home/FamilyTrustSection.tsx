...
const stats = [
  {
    icon: Users,
    value: "100+",
    label: "Ohio Families Protected",
    color: "from-primary/20 to-lavender-200/30",
  },
  {
    icon: Shield,
    value: "24/7",
    label: "Monitoring & Alerts",
    color: "from-accent/20 to-coral-200/30",
  },
  {
    icon: Award,
    value: "Client-Reviewed",
    label: "Trusted Feedback",
    color: "from-success/20 to-teal-200/30",
  },
];
...
export const FamilyTrustSection = () => {
  return (
    <section
      className="py-14 lg:py-20 bg-gradient-to-br from-background via-lavender-50/20 to-coral-50/15 dynamic-gradient-overlay"
    ...
    >
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-10">
          ...
          <h2
            id="trust-heading"
            className="text-3xl md:text-4xl lg:text-5xl font-black text-foreground leading-tight mb-4"
        ...
        >
          ...
          >
            <div
              className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center shadow-3d"
              aria-hidden="true"
            >
            ...
            <div className="widget-stat">
              ...
              <span className="stat-label text-base mt-2">
                Ohio Families Protected
              </span>
            </div>
          ...
          {stats.slice(1).map((stat) => (
            ...
            >
              <div
                className={`w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-br ${stat.color} flex items-center justify-center shadow-3d`}
                aria-hidden="true"
              >
        ...
        <div
          className="glass-heavy rounded-2xl p-6 lg:p-8 shadow-3d-lg subtle-3d-surface"
          role="list"
