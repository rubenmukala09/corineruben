...
export const TrustedExpertsBar = () => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #FAF9F7 0%, #FFF5F0 50%, #FAF9F7 100%)",
      }}
    >
      {/* Decorative Elements */}
      <motion.div
        ...
        >
          ...
          <div className="flex items-center gap-8">
            <div className="text-center">
              ...
              <div className="text-[10px] text-[#1a1a2e]/50 uppercase tracking-wider font-semibold">
                Veteran Discount
              </div>
            </div>
            <div className="text-center">
        ...
        <div className="text-center mb-12 relative z-10">
          ...
          <div className="flex items-center justify-center gap-4 lg:gap-6 flex-wrap">
            {logos.map((logo, i) => (
              ...
              >
                <span
                  className="text-base font-bold text-[#18305A]/50 hover:text-[#7C3AED] transition-colors"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 relative z-10">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-sm text-[#1a1a2e]/50 font-medium">
                {stat.label}
              </div>
            </motion.div>
          ))}
