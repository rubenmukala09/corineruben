...
export default function SuperAdminUserManagement() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      await logAction("view_logs", "user", undefined, {
          ...
          <DialogContent className="bg-[#1F2937] border-gray-700 text-white">
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-400">
                This will clear the user's tasks and events. This action cannot
                be undone.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
        ...
        >
          <DialogContent className="bg-[#1F2937] border-gray-700 text-white">
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-400">
                This will suspend the user's account. They will not be able to
