      ...
      <div className="absolute inset-0 grid lg:grid-cols-[45%_55%]">
        ...
        <div className="relative hidden lg:block overflow-hidden">
          ...
          >
            ...
            >
              <motion.div 
                animate={{ scale: [1, 1.15, 1], boxShadow: ['0 0 0 0 rgba(34,197,94,0.4)', '0 0 0 8px rgba(34,197,94,0)', '0 0 0 0 rgba(34,197,94,0.4)'] }}
                transition={{ duration: 2, repeat: Infinity }}
                className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-lg"
              >
                <Shield className="w-6 h-6 text-white" />
              </motion.div>
              <div>
                <div className="text-[11px] font-bold text-green-600 uppercase tracking-wider">Protected</div>
                <div className="text-xl font-black text-foreground">500+ Families</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="text-[11px] font-medium text-white/90">Success Rate</div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div className="text-[10px] font-medium text-muted-foreground">Support</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                <div className="text-base font-black text-foreground">4+ Years</div>
                <div className="text-[10px] font-medium text-muted-foreground">Experience</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-bold text-white">Ohio</span>
            </motion.div>
          </motion.div>
