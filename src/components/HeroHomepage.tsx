...
import { ArrowRight, Shield, Phone, Users, TrendingUp, Zap } from "lucide-react";
    ...
    <section className="relative min-h-[100vh] overflow-hidden bg-background">
      ...
      <div className="absolute inset-0">
        <img
          ...
          fetchPriority="high"
        />
        {/* Warm gradient overlay from left */}
        <div className="absolute inset-0 bg-gradient-to-r from-[hsl(30_20%_96%)] via-[hsl(30_20%_96%/0.88)] to-transparent lg:via-[hsl(30_20%_96%/0.72)]" />
        <div className="absolute inset-0 bg-gradient-to-t from-[hsl(30_20%_96%)] via-transparent to-[hsl(30_20%_96%/0.3)]" />
      </div>
          ...
          <div className="min-h-[100vh] flex flex-col justify-center py-28 lg:py-32 max-w-3xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                <div
                  key={stat.label}
                  className="rounded-2xl bg-card/80 backdrop-blur-xl border border-border/40 p-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
                >
      ...
      {/* Right-side floating glass widgets (desktop only) */}
