        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-screen py-32 lg:py-0">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-muted-foreground tracking-wide">Veteran-Owned • Ohio-Based • Trusted</span>
            </motion.div>
            
            {/* Headline */}
            <motion.h1 
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-foreground leading-[0.95] mb-8 tracking-tight"
            ...
            >
              ...
              <span className="block font-light text-muted-foreground text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-2">Starts Here</span>
            </motion.h1>
            ...
            >
              <Button asChild size="lg" className="group h-14 px-8 text-base font-semibold rounded-xl shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300">
                <Link to="/services">
                  Get Protected Now
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="group h-14 px-8 text-base font-semibold rounded-xl border-border/50 hover:bg-muted/50 transition-all duration-300">
            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {/* Pulsing glow */}
                  <motion.div 
                    className="absolute inset-12 rounded-full bg-gradient-to-br from-primary/30 to-accent/20 blur-2xl"
                    animate={{ 
                      scale: [1, 1.2, 1],
                      opacity: [0.5, 0.8, 0.5]
                    }}
                  ...
                  {/* Inner solid circle */}
                  <div className="absolute inset-16 rounded-full bg-gradient-to-br from-primary to-primary/80 shadow-2xl shadow-primary/30" />
                ...
                {securityFeatures.map((feature, index) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div 
                        className="flex items-center gap-2.5 px-4 py-2.5 bg-card/90 backdrop-blur-xl rounded-full border border-border/50 shadow-lg"
              ...
              >
                {[
                  ...
                  <motion.div 
                    key={stat.label}
                    className="text-center p-4 bg-card/50 backdrop-blur-sm rounded-2xl border border-border/30"
