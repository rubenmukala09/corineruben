...
const instructors: Instructor[] = [
  ...
  },
  {
    ...
    shortBio:
      "At 45, a Fortune 500 security consultant helping businesses protect their teams and data.",
    fullBio:
      "At 45, Robert Mitchell has consulted for some of the world's largest corporations on cybersecurity training and awareness programs. His engaging presentation style and real-world case studies make security training memorable and actionable. He specializes in helping organizations build a culture of security awareness, from the C-suite to front-line employees. His business protection workshops are trusted by companies nationwide.",
    achievements: [
          ...
          <ScrollReveal>
            <div className="text-center mb-10">
              <Badge className="mb-4 bg-gradient-to-r from-primary to-accent text-white text-base px-5 py-2">
                <GraduationCap className="w-5 h-5 mr-1.5" /> MEET YOUR
                INSTRUCTORS
              </Badge>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
                Our instructors combine decades of real-world experience with a
                passion for teaching. Select an instructor to view their
      ...
      >
        <DialogContent className="premium-crystal premium-shadow-depth premium-border-glow max-w-lg p-0 overflow-hidden bg-card">
          ...
          <DialogDescription className="sr-only">
            View the biography, achievements, and experience of{" "}
