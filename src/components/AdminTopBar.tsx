      ...
      <div className="flex items-center justify-between h-full px-2 sm:px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={profileRef}>
            <Button variant="ghost" className="flex items-center gap-2 h-10" onClick={() => setProfileOpen(!profileOpen)}>
              <Avatar className="h-8 w-8">
                <AvatarFallback className="bg-primary text-primary-foreground">{getInitials(adminName)}</AvatarFallback>
              </Avatar>
            ...
            {profileOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-popover border rounded-lg shadow-xl z-50">
                ...
                <div className="p-2">
                  <Button variant="ghost" className="w-full justify-start" onClick={() => { navigate("/admin/settings"); setProfileOpen(false); }}>
