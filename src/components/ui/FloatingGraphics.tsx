...
export const FloatingGraphics = ({
      ...
      >
        ...
        >
          <svg
            ...
            height="40"
            viewBox="0 0 40 40"
            className={`text-accent/15 ${baseOpacity}`}
          >
  ...
  if (variant === "mesh") {
    return (
      ...
      >
        <svg
          className={`absolute inset-0 w-full h-full ${baseOpacity}`}
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <polygon
              points="40,40 10,25 10,55 40,70"
              fill="hsl(var(--primary))"
              opacity="0.2"
            />
          </svg>
        ...
        >
          ...
          >
            ...
            />
            <polygon
              points="30,35 55,20 55,45 30,60"
              fill="hsl(var(--primary))"
              opacity="0.15"
            />
          </svg>
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M25 5 L45 15 L45 35 Q45 50 25 55 Q5 50 5 35 L5 15 Z"
              fill="none"
              stroke="hsl(var(--primary))"
              strokeWidth="2"
              opacity="0.4"
            />
            <path
              d="M25 15 L35 20 L35 32 Q35 42 25 45 Q15 42 15 32 L15 20 Z"
              fill="hsl(var(--primary))"
              opacity="0.15"
            />
          </svg>
        ...
        >
          ...
          >
            <path
              d="M20 4 L36 12 L36 28 Q36 40 20 44 Q4 40 4 28 L4 12 Z"
              fill="hsl(var(--accent))"
              opacity="0.2"
              stroke="hsl(var(--accent))"
              strokeWidth="1.5"
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M8 14 L8 10 Q8 4 15 4 Q22 4 22 10 L22 14"
              fill="none"
              stroke="hsl(var(--primary))"
              strokeWidth="2"
              opacity="0.3"
  ...
  if (variant === "waves") {
    return (
      ...
      >
        <svg
          className={`absolute bottom-0 left-0 w-full h-40 ${baseOpacity}`}
