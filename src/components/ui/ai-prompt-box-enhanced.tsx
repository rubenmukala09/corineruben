...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => (
  <textarea
    className={cn(
      "ai-prompt-textarea flex w-full rounded-md border-none bg-transparent px-3 py-2.5 text-base text-white placeholder:text-white/40 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] resize-none",
      className
    )}
    ref={ref}
    rows={1}
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      "z-50 overflow-hidden rounded-md border border-white/20 bg-black/80 backdrop-blur-sm px-3 py-1.5 text-sm text-white shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[90vw] md:max-w-[800px] translate-x-[-50%] translate-y-[-50%] gap-4 border border-white/20 bg-[#121212] p-0 shadow-xl duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-2xl",
        className
      )}
      {...props}
    >
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-white/10 bg-[#121212] p-2 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300",
...
export const EnhancedPromptInputBox = React.forwardRef<HTMLDivElement, EnhancedPromptInputBoxProps>(
  (props, ref) => {
    const {
      onSend = () => {},
      onFileSelect,
    ...
    return (
      <>
        <PromptInput
          ...
          className={cn(
            "w-full max-w-[600px] bg-[#121212] border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 ease-in-out",
              ...
              <button
                ...
                className={cn(
                  ...
                  isRecording
                    ...
                    : "bg-transparent hover:bg-white/10 text-white/60 hover:text-white/90"
                )}
              >
                {isLoading ? (
