    ...
    return (
      <div className="floating-label-container">
        <textarea
          ref={ref}
          className={cn(
            "flex min-h-[120px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-transparent disabled:cursor-not-allowed disabled:opacity-50",
            "form-input floating-input transition-all duration-300 resize-none",
