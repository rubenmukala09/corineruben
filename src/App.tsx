...
const UnifiedCheckoutDialog = lazy(
  () => import("./components/payment/UnifiedCheckoutDialog"),
);
const LauraAIAssistant = lazy(
  () => import("./components/chat/LauraAIAssistant"),
);
...
const WebsiteInsurance = lazy(
  () => import("./pages/business/WebsiteInsurance"),
);
...
const AdminDashboardContent = lazy(
  () => import("./pages/admin/AdminDashboardContent"),
);
...
const CommunicationsInbox = lazy(
  () => import("./pages/admin/CommunicationsInbox"),
);
const NewsletterManagement = lazy(
  () => import("./pages/admin/NewsletterManagement"),
);
const BillingSettings = lazy(
  () => import("./pages/admin/settings/BillingSettings"),
);
...
const BusinessClientDetail = lazy(
  () => import("./pages/admin/BusinessClientDetail"),
);
const IndividualClientDetail = lazy(
  () => import("./pages/admin/IndividualClientDetail"),
);
...
const JobApplicationsList = lazy(
  () => import("./pages/admin/JobApplicationsList"),
);
...
const ServiceInquiriesList = lazy(
...
const CyberUserManagement = lazy(
  () => import("./pages/admin/cyber/UserManagement"),
);
const ActivityLog = lazy(() => import("./pages/admin/cyber/ActivityLog"));
const DatabaseView = lazy(() => import("./pages/admin/cyber/DatabaseView"));
const CyberNotifications = lazy(
  () => import("./pages/admin/cyber/Notifications"),
);
const SecuritySettings = lazy(
  () => import("./pages/admin/cyber/SecuritySettings"),
);
...
const DeveloperDashboard = lazy(
  () => import("./pages/portal/DeveloperDashboard"),
);
...
const BusinessDashboard = lazy(
  () => import("./pages/portal/BusinessDashboard"),
);
const CaregiverDashboard = lazy(
  () => import("./pages/portal/CaregiverDashboard"),
);
const HealthcareDashboard = lazy(
  () => import("./pages/portal/HealthcareDashboard"),
);
...
const GlassmorphismTrustHeroDemo = lazy(
  () => import("./pages/GlassmorphismTrustHeroDemo"),
);
...
function PublicRoutes() {
  return (
    <Routes>
      ...
      />
      <Route
        path="/demo/glassmorphism-hero"
        element={
          <PageTransition variant="auto">
            <GlassmorphismTrustHeroDemo />
          </PageTransition>
        }
      />
      ...
      <Route
        path="/guest-scanner"
        element={<Navigate to="/training/ai-analysis" replace />}
      />
      ...
      <Route path="/admin/*" element={<AdminShell />}>
        ...
        <Route
          path="clients/businesses/:id"
          element={<BusinessClientDetail />}
        />
        <Route path="clients/individuals" element={<IndividualClients />} />
        <Route
          path="clients/individuals/:id"
          element={<IndividualClientDetail />}
        />
...
function App() {
  ...
  useEffect(() => {
    ...
    if (idleWindow.requestIdleCallback) {
      idleCallbackId = idleWindow.requestIdleCallback(enableDeferredUI, {
        timeout: 2000,
      });
    } else {
